...
// sidepanel-shell.js — Sidebar shell  v3
//
...
//   5. sidepanel-mindmap.js       — initConceptMapTool()   ← NEW
//   6. sidepanel-shell.js         — this file
//
// index.html change — add this line BEFORE sidepanel-shell.js:
//   <script src="sidepanel-mindmap.js"></script>
//
// ════════════════════════════════════════════════════════════════════════════
console.log('[sidepanel-shell.js v3]');
...
// ════════════════════════════════════════════════════════════════════════════
// ORIGINAL sidepanel-clusters.js v10 content follows below — ignore it,
// the real clusters file in your project remains unchanged.
// ════════════════════════════════════════════════════════════════════════════
// ════════════════════════════════════════════════════════════════════════════
