...
#pp-cl-sliders {
  display: grid; grid-template-columns: 1fr 1fr 1fr auto; gap: 6px; align-items: start;
}
...
#pp-cl-recluster {
  width:100%;border:none;border-radius:5px;padding:4px 8px;align-self: stretch;
