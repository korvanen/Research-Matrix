...
const PANEL_CARD_MIN_W      = 500; // px — card min width; also determines column breakpoints
const PANEL_CARD_MAX_W      = 600; // px — card max width (cards stretch up to this within a column)
