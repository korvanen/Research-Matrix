...
.pp-cmap-parent-count { font-size:8px; font-weight:700; letter-spacing:.06em; padding:1px 5px; border-radius:8px; flex-shrink:0; align-self:center; background:color-mix(in srgb, var(--ppc-on,#fff) 20%, transparent); color:color-mix(in srgb, var(--ppc-on,#fff) 90%, transparent); }
.pp-cmap-merged-count { font-size:8px; font-weight:700; letter-spacing:.07em; padding:1px 6px; border-radius:10px; margin-left:auto; opacity:.7; flex-shrink:0; }

.pp-cmap-card-body { padding:6px 9px 4px; display:flex; flex-direction:column; gap:4px; }
.pp-cmap-cell-cat { font-size:8px; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:var(--md-sys-color-on-surface-variant); margin-bottom:1px; }
...
.pp-cmap-card-footer { padding:4px 9px 7px; border-top:1px solid var(--md-sys-color-outline-variant); margin-top:2px; display:flex; flex-direction:column; gap:3px; }
...
.pp-cmap-leaf-badge { font-size:8px; font-weight:600; letter-spacing:.06em; text-transform:uppercase; color:var(--md-sys-color-on-surface-variant); padding:4px 9px 7px; display:block; }
`;
